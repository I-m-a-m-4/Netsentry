...
export default function SavedSessionsDrawer({ trigger }: SavedSessionsDrawerProps) {
 ...
 <span className="absolute -top-1 -right-1 h-4 w-4 flex items-center justify-center p-0 text-[10px] bg-primary text-primary-foreground rounded-md border border-background font-bold">
 ...
 className="p-4 rounded-md border bg-card hover: transition-all group"
 >
