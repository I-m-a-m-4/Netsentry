...
export function TauriUpdater() {
 ...
 >
 <div className="bg-primary text-primary-foreground px-4 py-2 rounded-md flex items-center gap-3 border border-white/20 ">
 {isDownloading ? (
 ...
 <div className="h-1.5 w-full bg-white/20 rounded-md overflow-hidden">
 <motion.div 
 ...
 className="h-8 rounded-md px-4 font-bold text-xs"
 >
