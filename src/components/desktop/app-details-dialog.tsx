...
export default function AppDetailsDialog({
 ...
 <span className={`text-[11px] font-semibold px-2.5 py-0.5 rounded-md border ${brand.badgeBg}`}>
 {brand.category}
 </span>
 {process.is_paused ? (
 <span className="bg-red-500/10 border border-red-500/30 text-red-500 text-[10px] font-bold px-2 py-0.5 rounded-md flex items-center gap-1">
 <span className="w-1.5 h-1.5 rounded-md bg-red-500" />
 Firewall Blocked
 </span>
 ) : (
 <span className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-500 text-[10px] font-bold px-2 py-0.5 rounded-md flex items-center gap-1">
 ...
 className={`px-4 py-2 rounded-md text-xs font-bold flex items-center gap-2 border transition-all cursor-pointer ${
 process.is_paused
 ...
 <div className="flex items-center gap-1.5 bg-background border border-border/70 rounded-md p-1 text-xs">
 {[
 { days: 7, label: '7 Days' },
