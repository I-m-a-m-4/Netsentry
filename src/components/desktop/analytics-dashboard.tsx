...
export default function AnalyticsDashboard({
 ...
 const cardBase = `border rounded-lg p-5 transition-all ${
 ...
 className={`flex items-center gap-1.5 px-3 py-1.5 border rounded-md text-xs font-semibold transition-all ${
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 bg-primary/10 hover:bg-primary/20 text-primary border border-primary/30 rounded-md text-xs font-semibold transition-all cursor-pointer"
 >
 ...
 className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-500 border border-emerald-500/30 rounded-md text-xs font-semibold transition-all cursor-pointer"
 >
 ...
 disabled={focusModeLoading || tauriStatus !== 'connected'}
 className="flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white text-xs font-bold px-4 py-2.5 rounded-md shadow transition-all cursor-pointer"
 >
 ...
 <span className="text-xs px-2.5 py-1 rounded-md bg-emerald-500/10 text-emerald-500 border border-emerald-500/30 font-semibold">
 Stable Connection
 </span>
 </div>
 ...
 <span className="text-xs px-2.5 py-1 rounded-md bg-primary/10 text-primary border border-primary/30 font-semibold">
 Conserved: ~1,190 MB
 </span>
 </div>
