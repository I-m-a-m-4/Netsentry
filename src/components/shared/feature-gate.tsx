...
export default function FeatureGate({
 ...
 const UpgradeNotice = () => (
 <div className="text-center p-8 bg-card border rounded-lg max-w-md">
 <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-md bg-primary/10 mb-4">
 ...
 <div className="absolute inset-0 bg-background/80 z-10 flex items-center justify-center rounded-lg p-4">
 <UpgradeNotice />
 </div>
 </div>
 )
