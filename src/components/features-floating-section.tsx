...
const FeatureIcon = ({ icon: Icon, label, className }: FeatureIconProps) => {
 ...
 <div className="w-16 h-16 bg-white rounded-md flex items-center justify-center text-primary">
...
export function FeaturesFloatingSection() {
 ...
 <Button asChild size="lg" className="bg-primary hover:bg-orange-600 text-white px-8 h-12 text-base font-medium rounded-md shadow-orange-900/10">
 <Link href="/signup">
 Get Started
 </Link>
 </Button>
 ...
 <div className="flex items-center gap-3 p-4 bg-white/80 rounded-md border border-orange-100/50">
