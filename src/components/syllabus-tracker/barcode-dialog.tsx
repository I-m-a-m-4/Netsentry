...
const BarcodePrintContent = React.forwardRef<HTMLDivElement, { product: Subject, currencySymbol: string }>(({ product, currencySymbol }, ref) => {
 return (
...
export default function BarcodeDialog({ product, isOpen, onOpenChange }: BarcodeDialogProps) {
 ...
 const { currencySymbol } = useAcademy();
 ...
 <DialogContent>
 <DialogHeader>
 <DialogTitle>Subject Barcode</DialogTitle>
 <DialogDescription>
