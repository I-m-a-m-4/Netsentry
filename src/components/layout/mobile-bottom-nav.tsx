...
export default function MobileBottomNav({ navItems, moreNavItems, isLoading }: MobileBottomNavProps) {
 ...
 return (
 <nav className="fixed bottom-0 left-0 right-0 h-[calc(4rem+env(safe-area-inset-bottom))] pb-[env(safe-area-inset-bottom)] bg-background/95 border-t border-border z-40 md:hidden no-print">
