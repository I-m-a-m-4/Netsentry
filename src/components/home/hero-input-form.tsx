...
export function HeroInputForm() {
 ...
 <span className="flex items-center justify-center w-full text-center bg-[#1e293b] text-white hover:bg-[#0f172a] transition-colors text-sm font-semibold tracking-wide font-dm-sans rounded-md py-2 px-5 whitespace-nowrap h-full min-h-[4rem] leading-tight">
 Get Started
 </span>
 </Link>
 </div>
