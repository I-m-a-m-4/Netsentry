...
export function ZenAIInsights() {
 ...
 <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-0.5 h-[60%] via-primary/20 "></div>
 </div>

 {/* Central AI Node */}
 <div className="relative z-10 mb-8">
 <div className="w-14 h-14 bg-slate-900 rounded-md flex items-center justify-center ring-4 ring-white">
 ...
 <div className="absolute -top-3 -left-3 bg-white border border-slate-100 p-1.5 rounded-md z-20">
 <Bot className="w-4 h-4 text-emerald-600" />
 </div>

 {/* Clipped Card Container */}
 <div className={`relative rounded-lg rounded-tl-sm overflow-hidden bg-white transition-all duration-300 ${isExamPulsing ? 'p-[2px]' : 'border border-slate-100'}`}>
 ...
 >
 <div className="absolute -top-3 -right-3 bg-white border border-slate-100 p-1.5 rounded-md z-20">
 <Bot className="w-4 h-4 text-blue-600" />
 </div>

 <div className={`relative rounded-lg rounded-tr-sm overflow-hidden bg-white transition-all duration-300 ${isAdmissionPulsing ? 'p-[2px]' : 'border border-slate-100'}`}>
