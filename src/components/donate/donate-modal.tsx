...
export default function DonateModal({ open, onOpenChange }: DonateModalProps) {
 ...
 >
 {tier.popular && (
 <span className="absolute -top-2 right-2 px-1.5 py-0.2 bg-primary text-[9px] font-bold text-primary-foreground rounded-md">
 Popular
 </span>
 )}
 ...
 className="w-full font-bold h-11 bg-primary text-primary-foreground hover:bg-primary/90 rounded-md flex items-center justify-center gap-2 "
 >
 {isLoading ? (
