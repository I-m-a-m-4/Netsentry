...
export function GlobalAnnouncement() {
 ...
 className={`fixed top-[var(--tauri-title-height,0)] left-0 right-0 z-[100] ${bgColors[broadcast.type] || 'bg-primary'} text-white `}
 >
 ...
 className="text-white hover:bg-white/20 h-8 w-8 rounded-md"
 >
 <X className="h-4 w-4" />
 </Button>
 </div>
