...
export default function NotFound() {
 ...
 className="relative"
 >
 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-md border border-slate-200 bg-white mb-6 ">
 ...
 variant="outline" 
 size="lg" 
 className="h-14 px-10 rounded-lg border-slate-200 bg-white text-slate-950 hover:bg-slate-50 hover:text-slate-950 transition-all font-bold group cursor-pointer"
 ...
 <Button 
 size="lg" 
 className="h-14 px-10 rounded-lg bg-primary text-white hover:bg-primary/95 transition-all font-bold cursor-pointer"
 >
 Go Home
 </Button>
 </Link>
